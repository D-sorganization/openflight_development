...
| Min Ball Speed | 15 mph                 | Filter club waggle and slow movements (35 mph for non-default SpeedTriggeredCapture) |
...
│   ├── ballistics.py          # Ballistic trajectory & carry model
