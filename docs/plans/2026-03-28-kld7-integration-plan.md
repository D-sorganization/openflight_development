...
class KLD7Tracker:
    ...
    def get_angle_for_shot(self) -> Optional[KLD7Angle]:
        ...
        event_detections = [d for d in detections if abs(d[0] - peak_time) < 0.5]
...
```python
parser.add_argument("--kld7", action="store_true", help="Enable K-LD7 angle radar module")
parser.add_argument(
