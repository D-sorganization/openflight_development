...
def main() -> None:
    ...
    p.add_argument(
        ...
        type=Path,
        default=Path(
            "/Users/john.pacino/Desktop/openflight_sessions/_analysis_terminal_shot_matching/terminal_shot_timing_strict_matches.csv"
        ),
    )
    p.add_argument("--long-name", default="20260523_143732_18deg_7iron_8shots")
    p.add_argument(
        "--first-byte-trigger-delay-ms",
        type=float,
        default=68.0,
    ...
    print(
        f"{'shot':>4}  {'OPS ball_ts_ms':>14}  {'STFT onset_ms':>14}  "
    ...
    for shot_n in sorted(captures.keys()):
        ...
        if fb_ts is not None and ops_ball_ms is not None:
            ...
            pi_impact_ts = fb_ts - trigger_delay_s - (trigger_off_ms - ops_ball_ms) / 1000.0
        ...
        print(
            f"{shot_n:>4}  {ops_str:>14}  {stft_str:>14}  {agree_str:>13}  "
