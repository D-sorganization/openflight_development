...
def parse_args():
    parser = argparse.ArgumentParser(description="Test camera ball detection interactively")
    parser.add_argument(
        "--resolution",
    ...
    try:
        for i in range(args.num_frames):
            ...
            if detection is not None:
                ...
                print(f"[{i + 1:4d}/{args.num_frames}] no detection  fps={1.0 / frame_elapsed:.1f}")
