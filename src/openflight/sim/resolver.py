...
from openflight.club_data import CLUB_TYPICAL_SPIN_RPM, OPTIMAL_LAUNCH, ClubType
...
# Canonical per-club spin model (rpm), used when measured spin is absent/low-confidence.
SPIN_MODEL_RPM: Dict[ClubType, float] = CLUB_TYPICAL_SPIN_RPM
_OPTIMAL_LAUNCH: Dict[ClubType, float] = OPTIMAL_LAUNCH
